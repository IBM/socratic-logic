...
lukasiewicz = [
    ...
    Equiv(Not(WeakAnd(phi, psi)), WeakOr(Not(phi), Not(psi))),
    Equiv(Not(WeakOr(phi, psi)), WeakAnd(Not(phi), Not(psi))),
    Equiv(Not(And(phi, psi)), Or(Not(phi), Not(psi))),
    Equiv(Not(Or(phi, psi)), And(Not(phi), Not(psi))),
    Implies(psi, Or(phi, psi)),
    Implies(Or(phi, psi), Or(psi, phi)),
    Equiv(Or(phi, Or(psi, chi)), Or(Or(phi, psi), chi)),
